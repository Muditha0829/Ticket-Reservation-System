...
public class UserApiClient {
    ...
    private static final String API_URL = "http://pasinduperera-001-site1.atempurl.com/api/users/getallusers"; // Replace with your API endpoint
    ...
    public static void deleteUserFromAPI(final User user, final OnUserDeletedListener listener) {
        AsyncTask<Void, Void, String> task = new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... voids) {
                try {
                    URL url = new URL("http://pasinduperera-001-site1.atempurl.com/api/users/deleteuser/" + user.getID());
                    HttpURLConnection connection = (HttpURLConnection) url.openConnection();
    ...
    private User parseJson(String json) throws JSONException {
        ...
        User user = new User(ID, firstName, lastName, userName, email, NIC, gender, contactNumber, userType, password, reenteredPassword, userStatus);
        return user;
    }
//            private static String fetchNICFromAPI(String userID) {
//                try {
//                    URL url = new URL("http://pasinduperera-001-site1.atempurl.com/api/users/getNIC/" + userID);
//                    HttpURLConnection connection = (HttpURLConnection) url.openConnection();
...
//        try {
//            URL url = new URL("http://pasinduperera-001-site1.atempurl.com/api/users/updatestatusbyid/" + userId);
...
//            protected String doInBackground(Void... voids) {
//                try {
//                    URL url = new URL("http://pasinduperera-001-site1.atempurl.com/api/users/get/" + userID);
//                    HttpURLConnection urlConnection = (HttpURLConnection) url.openConnection();
//                    BufferedReader reader = new BufferedReader(new InputStreamReader(urlConnection.getInputStream()));
//                    StringBuilder stringBuilder = new StringBuilder();
//
